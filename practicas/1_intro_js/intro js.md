...
Desde ES2015, se puede usar una sintaxis abreviada para definir métodos en notación literal ("*concise method syntax*"). Así, podemos ahorrarnos el `function` al definir el método:
